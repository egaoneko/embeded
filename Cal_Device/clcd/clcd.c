 ...
 * Description: CLCD control module program
 *            : with XHYPER270-TKU
 * =================================================
 */
...
static void string_out(char *str)
{
	...
	for (s=str; *s; s++){
		...
		/* if length of a string over 15 characters, change the line */
		/*
		if(i == 15) { 
			udelay(100);
			*((volatile unsigned char *)(mem_base_wr)) = 0xC0; 
...
/*print a string on upper line, but not used*/  
...
/*print a string on below line, but not used*/
...
/* change the line location following the value of flag*/
