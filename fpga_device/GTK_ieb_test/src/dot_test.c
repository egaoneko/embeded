...
void dot1_tog(){
        if (! check_dot1)
                { DOT_SET(0, 0x40);     check_dot1 = 1; }
        else    { DOT_CLEAR(0, 0x40);   check_dot1 = 0; }
}

void dot2_tog(){
        if (! check_dot2)
                { DOT_SET(1, 0x40);     check_dot2 = 1; }
        else    { DOT_CLEAR(1, 0x40);   check_dot2 = 0; }
}
void dot3_tog(){
        if (! check_dot3)
                { DOT_SET(2, 0x40);     check_dot3 = 1; }
        else    { DOT_CLEAR(2, 0x40);   check_dot3 = 0; }
}

void dot4_tog(){
        if (! check_dot4)
                { DOT_SET(3, 0x40);     check_dot4 = 1; }
        else    { DOT_CLEAR(3, 0x40);   check_dot4 = 0; }
}

void dot5_tog(){
        if (! check_dot5)
                { DOT_SET(4, 0x40);     check_dot5 = 1; }
        else    { DOT_CLEAR(4, 0x40);   check_dot5 = 0; }
}
...
void dot6_tog(){
        if (! check_dot6)
                { DOT_SET(0, 0x20);     check_dot6 = 1; }
        else    { DOT_CLEAR(0, 0x20);   check_dot6 = 0; }
}

void dot7_tog(){
        if (! check_dot7)
                { DOT_SET(1, 0x20);     check_dot7 = 1; }
        else    { DOT_CLEAR(1, 0x20);   check_dot7 = 0; }
}
void dot8_tog(){
        if (! check_dot8)
                { DOT_SET(2, 0x20);     check_dot8 = 1; }
        else    { DOT_CLEAR(2, 0x20);   check_dot8 = 0; }
}

void dot9_tog(){
        if (! check_dot9)
                { DOT_SET(3, 0x20);     check_dot9 = 1; }
        else    { DOT_CLEAR(3, 0x20);   check_dot9 = 0; }
}

void dot10_tog(){
        if (! check_dot10)
                { DOT_SET(4, 0x20);     check_dot10 = 1; }
        else    { DOT_CLEAR(4, 0x20);   check_dot10 = 0; }
}

/*************************   ROW3   ************************/
void dot11_tog(){
        if (! check_dot11)
                { DOT_SET(0, 0x10);     check_dot11 = 1; }
        else    { DOT_CLEAR(0, 0x10);   check_dot11 = 0; }
}

void dot12_tog(){
        if (! check_dot12)
                { DOT_SET(1, 0x10);     check_dot12 = 1; }
        else    { DOT_CLEAR(1, 0x10);   check_dot12 = 0; }
}
void dot13_tog(){
        if (! check_dot13)
                { DOT_SET(2, 0x10);     check_dot13 = 1; }
        else    { DOT_CLEAR(2, 0x10);   check_dot13 = 0; }
}

void dot14_tog(){
        if (! check_dot14)
                { DOT_SET(3, 0x10);     check_dot14 = 1; }
        else    { DOT_CLEAR(3, 0x10);   check_dot14 = 0; }
}
