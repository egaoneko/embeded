cmd_/root/embeded/DeviceDriver_20140524/btn/btn.o := /opt/iwmmxt-1.0.0/bin/arm-linux-gcc -Wp,-MD,/root/embeded/DeviceDriver_20140524/btn/.btn.o.d -nostdinc -isystem /opt/iwmmxt-1.0.0/lib/gcc/arm-linux/3.4.3/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mlittle-endian -mapcs-32 -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=xscale -Wa,-mcpu=xscale -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement    -DMODULE -DKBUILD_BASENAME=btn -DKBUILD_MODNAME=btn -c -o /root/embeded/DeviceDriver_20140524/btn/btn.o /root/embeded/DeviceDriver_20140524/btn/btn.c

deps_/root/embeded/DeviceDriver_20140524/btn/btn.o := \
  /root/embeded/DeviceDriver_20140524/btn/btn.c \
...
/root/embeded/DeviceDriver_20140524/btn/btn.o: $(deps_/root/embeded/DeviceDriver_20140524/btn/btn.o)
