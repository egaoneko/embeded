cmd_/root/문서/fpga_device/fnd/fnd.mod.o := /opt/iwmmxt-1.0.0/bin/arm-linux-gcc -Wp,-MD,/root/문서/fpga_device/fnd/.fnd.mod.o.d -nostdinc -isystem /opt/iwmmxt-1.0.0/lib/gcc/arm-linux/3.4.3/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -Os     -fno-omit-frame-pointer -fno-omit-frame-pointer -mapcs -mno-sched-prolog -mlittle-endian -mapcs-32 -D__LINUX_ARM_ARCH__=5 -march=armv5te -mtune=xscale -Wa,-mcpu=xscale -malignment-traps -msoft-float -Uarm -Wdeclaration-after-statement     -DKBUILD_BASENAME=fnd -DKBUILD_MODNAME=fnd -DMODULE -c -o /root/문서/fpga_device/fnd/fnd.mod.o /root/문서/fpga_device/fnd/fnd.mod.c

deps_/root/문서/fpga_device/fnd/fnd.mod.o := \
  /root/문서/fpga_device/fnd/fnd.mod.c \
...
/root/문서/fpga_device/fnd/fnd.mod.o: $(deps_/root/문서/fpga_device/fnd/fnd.mod.o)
